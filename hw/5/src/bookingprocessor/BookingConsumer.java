...
public class BookingConsumer implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            System.out.println("[booking-processor] Booking received: " + msgText);
            System.out.println("[booking-processor]   >> processing booking... done.");
            
        } catch (JMSException jmse) {
            System.err.println("[booking-processor] An exception occurred: " + jmse.getMessage());
        } catch (Exception e) {
    ...
    public void receive(String queueName) throws Exception {
        ...
        System.out.println("[booking-processor] Connected to " + queue.toString() + ", receiving messages...");
        try {
            synchronized (this) {
                while (true) {
                    this.wait();
            ...
            close();
            System.out.println("[booking-processor] Finished.");
        }
    }
