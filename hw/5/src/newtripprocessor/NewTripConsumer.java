...
public class NewTripConsumer implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            System.out.println("[newtrip-processor] New trip received: " + msgText);
            System.out.println("[newtrip-processor]   >> processing trip... done.");
            
        } catch (JMSException jmse) {
            System.err.println("[newtrip-processor] An exception occurred: " + jmse.getMessage());
        } catch (Exception e) {
    ...
    public void receive(String queueName) throws Exception {
        ...
        System.out.println("[newtrip-processor] Connected to " + queue.toString() + ", receiving messages...");
        try {
            synchronized (this) {
                while (true) {
                    this.wait();
            ...
            close();
            System.out.println("[newtrip-processor] Finished.");
        }
    }
